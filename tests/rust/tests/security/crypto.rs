...
fn test_encrypt_empty_string() {
    ...
    let ciphertext = encryptor.encrypt(plaintext).expect("Failed to encrypt empty");
    let decrypted = encryptor.decrypt(&ciphertext).expect("Failed to decrypt empty");
...
fn test_encrypt_unicode() {
    ...
    let ciphertext = encryptor.encrypt(plaintext).expect("Failed to encrypt unicode");
    let decrypted = encryptor.decrypt(&ciphertext).expect("Failed to decrypt unicode");
...
fn test_encrypt_large_data() {
    ...
    let ciphertext = encryptor.encrypt(&plaintext).expect("Failed to encrypt large");
    let decrypted = encryptor.decrypt(&ciphertext).expect("Failed to decrypt large");
